    ...
    <div class="content">
        ...
        <div class="data">
            <table>
                <tr>
                    <td width="30%">ID</td>
                    <td><input type="text" name="language_id" disabled="disable" 
                               class="text" size="11"
                               value="<?php echo set_value('language_id',$language_id); ?>"/></td>
                </tr>
                <tr>
                    <td valign="top">Language<span style="color:red;">*</span></td>
                    <td><input type="text" name="language_txt"
                                class="text" size="30" 
                                value="<?php echo set_value('language_txt',$language_txt); ?>"/>
                </tr>
                <tr>
